...
Спринт 2 в работе. Шаги 2.1–2.5 закрыты:
...
57 тестов зелёные. Роутеров пока нет. Следующий шаг — 2.6 (`/api/documents` CRUD поверх сервисов, лимит 10 МБ). Детали — в [docs/sprint-2-plan.md](docs/sprint-2-plan.md). Команды — в [docs/dev.md](docs/dev.md).
